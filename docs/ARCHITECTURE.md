...
**결론**: TypeScript는 11/13 표면에서 "돌아가긴" 하지만, 3개 핵심 표면(CLI, Mobile, Edge)에서 구조적 한계가 있다. Rust는 13/13 모두 네이티브로 커버한다.
...
*"Infrastructure should be written in infrastructure languages."*
*— mdcore의 기술 철학*
