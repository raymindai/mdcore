...
<body>
  <div id="toolbar">
    ...
    <button data-action="h5" data-tip="Heading 5 — ##### text" data-preview="<span style='font-size:0.8em;font-weight:600;opacity:0.7'>Heading 5</span>"><span style="font-size:10px">H5</span></button>
    <button data-action="h6" data-tip="Heading 6 — ###### text" data-preview="<span style='font-size:0.75em;font-weight:600;opacity:0.7;text-transform:uppercase;letter-spacing:0.03em'>Heading 6</span>"><span style="font-size:10px">H6</span></button>
    <button data-action="p" data-tip="Paragraph — normal text" data-preview="<span style='font-size:0.85em'>Normal paragraph text</span>"><span style="font-size:10px">P</span></button>
    <span class="toolbar-divider"></span>
    ...
    <span class="toolbar-divider"></span>
    <button data-action="ul" data-tip="Bullet list → - item" data-preview="<div>• First item<br>• Second item</div>"><svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor"><circle cx="3" cy="4" r="1"/><circle cx="3" cy="8" r="1"/><circle cx="3" cy="12" r="1"/><rect x="6" y="3" width="8" height="2" rx="0.5"/><rect x="6" y="7" width="8" height="2" rx="0.5"/><rect x="6" y="11" width="8" height="2" rx="0.5"/></svg></button>
    <button data-action="ol" data-tip="Numbered list → 1. item" data-preview="<div>1. First item<br>2. Second item</div>"><svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor"><text x="1" y="5" font-size="4.5" font-weight="700">1</text><text x="1" y="9" font-size="4.5" font-weight="700">2</text><text x="1" y="13" font-size="4.5" font-weight="700">3</text><rect x="6" y="3" width="8" height="2" rx="0.5"/><rect x="6" y="7" width="8" height="2" rx="0.5"/><rect x="6" y="11" width="8" height="2" rx="0.5"/></svg></button>
    ...
    <span class="toolbar-divider"></span>
    <button data-action="blockquote" data-tip="Blockquote → > text" data-preview="<div style='border-left:3px solid #fb923c;padding-left:8px;font-style:italic;opacity:0.8'>Quoted text</div>"><svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor"><path d="M3 3h4v4H5.5L4 10H3V3zm6 0h4v4h-1.5L10 10H9V3z"/></svg></button>
