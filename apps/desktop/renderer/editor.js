...
(function () {
  ...
  function renderHomeScreen() {
    ...
    // ─── Examples click — load embedded markdown ───
    var EXAMPLES = {
      welcome: "# Welcome to mdfy\n\n> Your Markdown, Beautifully Published.\n\n## Get Started\n\n1. **Type or paste** anything — Markdown, plain text, AI output\n2. **Import** files — PDF, Word, PowerPoint, Excel, HTML, CSV, LaTeX\n3. **Edit** inline in the Live view, or use Source for raw Markdown\n4. **Share** with one click — generates a short URL like `mdfy.cc/abc123`\n\n## What You Can Do\n\n- **WYSIWYG editing** — click any text in the Live view and start typing\n- **AI Tools** — Polish, Summary, TL;DR, Translate, Chat (right panel)\n- **Document Outline** — heading structure at a glance\n- **Image Gallery** — upload, manage, insert images\n- **Multi-format import** — drag & drop PDF, DOCX, PPTX, XLSX\n- **Export** — MD, HTML, rich text for Docs/Email/Slack\n- **Cross-platform sync** — Web, VS Code, Mac Desktop, CLI\n\n---\n\n*Powered by mdcore engine — Rust + WASM*",
      features: "# Key Features\n\n## AI Tools\n\nClick the **AI** button to open the AI panel:\n\n- **Polish** — improve writing quality and clarity\n- **Summary** — generate a concise summary\n- **TL;DR** — extract key bullet points\n- **Translate** — translate to any language\n- **Chat** — natural language editing\n\n## Document Outline\n\nClick the **Outline** button to see heading hierarchy. Click any heading to scroll to it.\n\n## Image Gallery\n\nUpload images (WebP auto-conversion). Click to insert at cursor.\n\n## Cross-Platform\n\n- **Web** — mdfy.cc\n- **VS Code** — Extension with WYSIWYG preview\n- **Mac Desktop** — Native app with sidebar\n- **CLI** — `npm install -g mdfy-cli`\n- **Chrome** — Capture from ChatGPT, Claude, Gemini\n- **MCP** — AI agents create/read/update documents",
      syntax: "# Markdown Syntax Guide\n\n## Headings\n\n# Heading 1\n## Heading 2\n### Heading 3\n\n## Emphasis\n\n**Bold text** and *italic text* and ~~strikethrough~~\n\n## Lists\n\n- Item one\n- Item two\n  - Nested item\n\n1. First\n2. Second\n3. Third\n\n## Links & Images\n\n[mdfy.cc](https://mdfy.cc)\n\n## Code\n\nInline `code` and blocks:\n\n```javascript\nfunction hello() {\n  console.log(\"Hello, world!\");\n}\n```\n\n## Tables\n\n| Feature | Status |\n|---------|--------|\n| Tables | Done |\n| Math | Done |\n| Diagrams | Done |\n\n## Blockquotes\n\n> This is a blockquote.\n> It can span multiple lines.\n\n## Task Lists\n\n- [x] Completed task\n- [ ] Pending task",
      ...
      import: "# Import & Export Guide\n\n## Import Formats\n\nDrag & drop or use **File > Open** to import:\n\n| Format | Extension |\n|--------|----------|\n| Markdown | .md, .markdown |\n| PDF | .pdf |\n| Word | .docx |\n| PowerPoint | .pptx |\n| Excel | .xlsx |\n| HTML | .html |\n| CSV | .csv |\n| LaTeX | .tex |\n| Plain text | .txt |\n\n## Export Options\n\n- **Markdown** — download as .md file\n- **HTML** — self-contained HTML with styles\n- **Rich text** — paste into Google Docs, Word, Email\n- **Slack** — mrkdwn format for Slack\n- **PDF** — print to PDF via browser\n\n## Keyboard Shortcuts\n\n| Shortcut | Action |\n|----------|--------|\n| Cmd+N | New document |\n| Cmd+O | Open file |\n| Cmd+S | Save |\n| Cmd+Shift+P | Publish |",
    };
