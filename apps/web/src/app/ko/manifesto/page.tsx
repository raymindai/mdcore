...
export const metadata: Metadata = {
  ...
  description:
    "마크다운 URL이 AI 시대 지식의 substrate. 추출이 아닌 authorship. mdfy.cc 뒤에 숨겨진 더 큰 비전과 크로스 AI 퍼블리싱 레이어.",
  alternates: {
    canonical: "https://mdfy.cc/ko/manifesto",
    languages: { en: "https://mdfy.cc/manifesto" },
  },
  openGraph: {
    title: "내가 mdfy를 만드는 이유",
    description: "마크다운 URL이 AI 시대 지식의 substrate. mdfy.cc의 비전.",
