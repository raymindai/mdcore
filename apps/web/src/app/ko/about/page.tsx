...
export const metadata: Metadata = {
  title: "소개 — mdfy.cc",
  description:
    "mdfy.cc — 당신의 마크다운, 어디서든. ChatGPT, Claude 답변을 한 곳에 모으고. WYSIWYG으로 편집하고, 영구 URL로 공유하고, 어떤 AI에도 컨텍스트로 사용하세요.",
  alternates: {
    canonical: "https://mdfy.cc/ko/about",
    languages: { en: "https://mdfy.cc/about" },
  },
  openGraph: {
    title: "소개 — mdfy.cc",
    description:
