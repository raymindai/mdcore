...
const texts = {
  en: {
    ...
    mcp: {
      ...
      terminal: {
        ...
        lines: [
          ...
          { type: "output", text: "  URL: ", url: "https://mdfy.cc/d/abc123" },
    ...
    quicklook: {
      ...
      desc: "Press Space on any .md file in Finder to see it beautifully rendered \u2014 GFM tables, syntax highlighting, math, and Mermaid diagrams. Click \u201cOpen in mdfy\u201d to edit in the desktop app or web editor.",
      ...
      installHeading: "Install",
      installSteps: [
        "Download and unzip MdfyQuickLook.zip below",
        "Move MdfyQuickLook.app to Applications folder",
        "Open MdfyQuickLook.app once (registers the QuickLook extension)",
      ...
      downloadLabel: "Download QuickLook",
      downloadSize: "45 KB (.zip)",
  ...
  ko: {
    ...
    quicklook: {
      ...
      installHeading: "설치",
      installSteps: [
        "아래에서 MdfyQuickLook.zip을 다운로드하고 압축 해제하세요",
        "MdfyQuickLook.app을 Applications 폴더로 이동하세요",
        "MdfyQuickLook.app을 한 번 열어주세요 (QuickLook 확장 등록)",
