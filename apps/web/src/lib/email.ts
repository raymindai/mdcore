 ...
 * All emails use mdfy.cc dark branding: #09090b bg, #18181b card, #27272a border, #fb923c accent.
 */

const FROM_ADDRESS = "mdfy.cc <notifications@mdfy.cc>";
...
function footerHtml(to: string): string {
  ...
  <div style="margin-top:32px;padding-top:16px;border-top:1px solid #27272a">
    <p style="margin:0;font-size:11px;color:#52525b;line-height:1.6">
      This email was sent by <a href="https://mdfy.cc" style="color:#fb923c;text-decoration:none">mdfy.cc</a> to ${to}.<br/>
...
export async function sendWelcomeEmail(to: string): Promise<void> {
  const subject = "Welcome to mdfy.cc";
...
export async function sendWeeklyDigestEmail(
  ...
  const subject = "Your mdfy.cc weekly summary";
