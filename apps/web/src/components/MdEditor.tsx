              ...
              return (
                <div className="shrink-0">
                  <div
                    ...
                    style={{ background: "color-mix(in srgb, var(--background) 60%, var(--surface) 40%)", borderTop: "1px solid var(--border)", borderBottom: showRecent ? "1px solid var(--border)" : "none", position: "sticky", top: 0, zIndex: 10 }}
                ...
                {(() => {
                  ...
                  return (
                    <div
                      ...
                      className="flex items-center gap-1.5 px-3 h-7 cursor-pointer select-none group/sec hover:bg-[var(--toggle-bg)]"
                      style={{ background: "color-mix(in srgb, var(--background) 60%, var(--surface) 40%)", borderTop: "1px solid var(--border)", borderBottom: showMyBundles ? "1px solid var(--border)" : "none", position: "sticky", top: 0, zIndex: 10 }}
                  ...
                  {(() => {
                    ...
                    return (
                      <div
                        data-section-id="mds"
                        className="flex items-center gap-1.5 px-3 h-7 cursor-pointer select-none group/sec hover:bg-[var(--toggle-bg)]"
                        style={{ background: "color-mix(in srgb, var(--background) 60%, var(--surface) 40%)", borderTop: "1px solid var(--border)", borderBottom: showMyDocs ? "1px solid var(--border)" : "none", position: "sticky", top: 0, zIndex: 10 }}
            ...
            {isAuthenticated && conceptIndex && conceptIndex.concepts.length > 0 && (
              <div className="shrink-0 flex flex-col">
                <div
                  ...
                  className="flex items-center gap-1.5 px-3 h-7 cursor-pointer select-none group/sec hover:bg-[var(--toggle-bg)]"
                  style={{ background: "color-mix(in srgb, var(--background) 60%, var(--surface) 40%)", borderTop: "1px solid var(--border)", borderBottom: showConcepts ? "1px solid var(--border)" : "none", position: "sticky", top: 0, zIndex: 10 }}
              ...
              return (<>
                <div className="shrink-0 flex flex-col">
                  <div
                    ...
                    className="flex items-center gap-1.5 px-3 h-7 cursor-pointer select-none group/sec hover:bg-[var(--toggle-bg)]"
                    style={{ background: "color-mix(in srgb, var(--background) 60%, var(--surface) 40%)", borderTop: "1px solid var(--border)", borderBottom: showSharedDocs ? "1px solid var(--border)" : "none", position: "sticky", top: 0, zIndex: 10 }}
              ...
              return (<>
                <div className="shrink-0 flex flex-col">
                  <div
                    ...
                    className="flex items-center gap-1.5 px-3 h-7 cursor-pointer select-none group/sec hover:bg-[var(--toggle-bg)]"
                    style={{ background: "color-mix(in srgb, var(--background) 60%, var(--surface) 40%)", borderTop: "1px solid var(--border)", borderBottom: showTrash ? "1px solid var(--border)" : "none", position: "sticky", top: 0, zIndex: 10 }}
              ...
              return (
                <div className="shrink-0">
                  <div
                    ...
                    className="flex items-center gap-1.5 px-3 h-7 cursor-pointer select-none group/sec hover:bg-[var(--toggle-bg)]"
                    style={{ background: "color-mix(in srgb, var(--background) 60%, var(--surface) 40%)", borderTop: "1px solid var(--border)", borderBottom: !examplesCollapsed ? "1px solid var(--border)" : "none", position: "sticky", top: 0, zIndex: 10 }}
